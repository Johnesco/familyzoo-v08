# Family Zoo — v08 — Light & Dark — Claude Project Memory
...
**Name:** Family Zoo — v08 — Light & Dark
**Purpose:** Sharpee tutorial step 8 — Light & Dark.
...
**Repository:** https://github.com/Johnesco/familyzoo-v08
**Live:** https://johnesco.github.io/familyzoo-v08/
...
├── familyzoo-08.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v08.story`.
